...
<!--[if gt IE 9]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <title>LOGIN DESA KARANGSARI</title>
    ...
    <body>
        ...
        <div id="login-container">
            ...
            <h1 class="h2 text-light text-center push-top-bottom animation-slideDown">
                <i class="fa fa-users"></i> <br> <br> <strong>SELAMAT DATANG DI <br> SISTEM INFORMASI WARGA DESA KARANGSARI PANDEGLANG BANTEN</strong>
            </h1>
            <!-- END Login Header -->
